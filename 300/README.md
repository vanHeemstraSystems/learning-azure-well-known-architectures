...
|--------------------------|------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
|**N-Tier (Multi-tier)**   |• Azure Virtual Machines<br>• Azure Load Balancer<br>• Azure Application Gateway<br>• Network Security Groups (NSGs)<br>• Azure Virtual Network<br>• Azure SQL Database<br>• Azure Bastion (for secure management)|
